...
def generate_launch_description():
    ...
    robot_sdf_path=os.path.join(pkg_universal_robot_ign, 'resource', 'ur3_dg2f.sdf') 
    ...
    # ros<-ign, joint state publisher for ur
    ...
    #  ros->ign,  joint controller for ur
    ...
    ros_ign_bridge = Node(package='ros_gz_bridge',
            ...
            arguments=[
                ...
                '/model/ur3/gripper/target_position@std_msgs/msg/Float32@ignition.msgs.Float',
                ],
            remappings=[("/model/ur3/gripper/cmd","/gripper/cmd"),
                        ("/model/ur3/gripper/target_position","/gripper/target_position"),
                        ],
            output='screen'
    )
